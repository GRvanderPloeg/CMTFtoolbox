...
- initialization:
  ...
  components of the concatenated data using svd. Ignored and uses NPLS
  based initialization if pi=0.
...
- mu:
  ...
  Ridge term parameter for calculation of the regression coefficients
  rho (default = 1e-6).
